				...
				public void actionPerformed(ActionEvent arg0) {
					...
					try
					{
						...
						else if(track == 1)
						{
							...
							if(temp.equals("-"))
								app.class_path = pathSetup.bp + branch_in.getText() + ".txt";
							else
								app.class_path = pathSetup.cp + temp + ".txt";
							...
							for(int i=0; i<nb; i++)
							{
								app.branch_path = pathSetup.bp + branch.nextToken().trim() + ".txt";
			...
			con.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					try
					{
						...
						{
							String temp1 = pathSetup.bp + fas_in.getText() + ".txt";
							String temp2 = pathSetup.bp + class_in.getText() + ".txt";
